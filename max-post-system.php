...
function mps_survey_items() {
  $labels = array(
    'name'                  => _x( 'Survey', 'Post Type General Name', 'max-post' ),
    'singular_name'         => _x( 'Survey', 'Post Type Singular Name', 'max-post' ),
    'menu_name'             => __( 'Survey', 'max-post' ),
    'name_admin_bar'        => __( 'Survey', 'max-post' ),
    'archives'              => __( 'Survey Archives', 'max-post' ),
    'attributes'            => __( 'Survey Attributes', 'max-post' ),
    'parent_item_colon'     => __( 'Parent Survey:', 'max-post' ),
    'all_items'             => __( 'All Survey', 'max-post' ),
    'add_new_item'          => __( 'Add New Survey', 'max-post' ),
    'add_new'               => __( 'Add New', 'max-post' ),
    'new_item'              => __( 'New Survey', 'max-post' ),
    'edit_item'             => __( 'Edit Survey', 'max-post' ),
    'update_item'           => __( 'Update Survey', 'max-post' ),
    'view_item'             => __( 'View Survey', 'max-post' ),
    'view_items'            => __( 'View Survey', 'max-post' ),
    'search_items'          => __( 'Search Survey', 'max-post' ),
    'not_found'             => __( 'Not found', 'max-post' ),
    'not_found_in_trash'    => __( 'Not found in Trash', 'max-post' ),
    'featured_image'        => __( 'Featured Image', 'max-post' ),
    'set_featured_image'    => __( 'Set featured image', 'max-post' ),
    'remove_featured_image' => __( 'Remove featured image', 'max-post' ),
    'use_featured_image'    => __( 'Use as featured image', 'max-post' ),
    'insert_into_item'      => __( 'Insert into survey', 'max-post' ),
    'uploaded_to_this_item' => __( 'Uploaded to this survey', 'max-post' ),
    'items_list'            => __( 'Survey list', 'max-post' ),
    'items_list_navigation' => __( 'Survey list navigation', 'max-post' ),
    'filter_items_list'     => __( 'Filter survey list', 'max-post' ),
  );
  $args = array(
